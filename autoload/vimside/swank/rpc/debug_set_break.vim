...
function! g:DebugSetBreakHandler()
  ...
  function! g:DebugSetBreakHandler_Ok(sexp_rval)
call s:LOG("DebugSetBreakHandler_Ok ".  vimside#sexp#ToString(a:sexp_rval)) 
    let [found, dic] = vimside#sexp#Convert_KeywordValueList2Dictionary(a:sexp_rval) 
    if ! found 
      echoe "DebugSetBreak ok: Badly formed Response"
      call s:ERROR("DebugSetBreak ok: Badly formed Response: ". string(a:sexp_rval)) 
      return 0
    endif
